...
| Upcall pointer      | r2       | Opaque, userspace-specific function pointer type |
...
| Driver number    | r0       | `u32`              |                                                                  |
| Allow number     | r1       | `u32`              |                                                                  |
| Address          | r2       | `&mut [u32; {r3}]` | Pointer to array of userspace memory of length `{r3}` **or** `0` |
| Size             | r3       | `u32`              |                                                                  |
...
| Driver number    | r0       | `u32`          |                                                                  |
| Allow number     | r1       | `u32`          |                                                                  |
| Address          | r2       | `&[u32; {r3}]` | Pointer to array of userspace memory of length `{r3}` **or** `0` |
| Size             | r3       | `u32`          |                                                                  |
